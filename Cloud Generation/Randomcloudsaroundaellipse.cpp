...
void disjont_ellipse(int imageSize,int cloudSize,vector<dataPoint>& cloud1,int major_axis1,int minor_axis1)
{	
...
int main()
{
	...
	disjont_ellipse(imagesize,cloudSize,cloud1,major_axis1,minor_axis1);
